...
/* ROS */
extern uint32_t pios_com_ros_id;
#define PIOS_COM_ROS                 (pios_com_ros_id)
#ifndef PIOS_COM_ROS_TX_BUF_LEN
# define PIOS_COM_ROS_TX_BUF_LEN     2048
#endif
#ifndef PIOS_COM_ROS_RX_BUF_LEN
...
typedef enum {
    ...
    PIOS_BOARD_IO_USB_VCP_ROSBRIDGE    = HWSETTINGS_USB_VCPPORT_ROSBRIDGE,
