...
class MyModel(nn.Module):
    def __init__(self, o_space, a_space, hidden_sizes_a=(24, 24), hidden_sizes_c=(64, 64), squash=False, clamp=True,
                 output_log_sigma=False, device=torch.device('cpu'), log=False, rnn=False, activation='relu',
